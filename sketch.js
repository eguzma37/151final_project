...
// Addition of mousePressed function
...
function keyIsPressed(){
  if (keyPressed == True){
    background(255);
    let ellix = 0;
    let elliy = random(0,10);
    let ellidiameter = random(20,90);

    let col_r = random(0,195);
    let col_g = random(20,80);
    let col_b = 0;
  } else {
    return False;
  }
...
function keyTyped() {
  if (keyCode === UP_ARROW) {
    ...
    // Re-drawing the trio of spinning torus'
...
// Fixed the KeyIsPressed function
// function keyIsPressed() {
